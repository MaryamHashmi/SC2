...
public class Course implements java.io.Serializable {
    ...
    */
    public Course(String courseTitle, Date starttime, Date endtime, int creditHours) {
    ...
    */
    ...
    public String toString() {
        return "Course{" + "courseId=" + courseId + ", courseTitle=" + courseTitle + ", startsOn=" + startsOn + ", endsOn=" + endsOn + ", creditHours=" + creditHours + ", contents=" + contents + ", teacher=" + teacher + ", students=" + students + '}';
    }
